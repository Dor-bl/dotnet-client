...
The `Appium.Net` assembly shipped by the `Appium.WebDriver` package is strong-name signed with public key token `8b7475dcfe6734d4`. See the [`v9`](#v9) section above for migration details.
