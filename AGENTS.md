...
dotnet test ./test/integration/Appium.Net.Integration.Tests.csproj \
  ...
  --filter "AppiumLocalServerLaunchingTest|DirectConnectTest|AppiumClientConfigTest|AppiumServiceArgumentsTest"

# Windows only (single line so it also works in PowerShell)
dotnet test ./test/integration/Appium.Net.Integration.Tests.csproj --configuration Release --framework net48 --filter "AppiumLocalServerLaunchingTest|DirectConnectTest|AppiumClientConfigTest|AppiumServiceArgumentsTest"
```
